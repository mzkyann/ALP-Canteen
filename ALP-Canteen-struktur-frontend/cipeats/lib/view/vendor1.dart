...
class Vendor1Page extends ConsumerWidget {
  ...
  Widget build(BuildContext c, WidgetRef ref) {
    final menuAsync = ref.watch(menuByVendorProvider('Chick on Cup'));
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: menuAsync.when(
          ...
          data: (menus) => _buildContent(c, menus, 'Chick on Cup'),
        ),
      ),
    );
  }
      ...
      Scrollbar(
        child: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 16),
            Image.asset('assets/images/ChickonCup.png', width: 100, height: 100),
